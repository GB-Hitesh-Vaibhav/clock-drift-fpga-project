...
# Drift is modeled as linearly increasing delay
drift = np.linspace(0, drift_per_sec, total_samples)  # Cumulative drift
clock_2 = time + drift
...
df.to_csv("data/clock_drift.csv", index=False)
